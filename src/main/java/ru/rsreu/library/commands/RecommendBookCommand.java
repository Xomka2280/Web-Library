...
public class RecommendBookCommand extends FrontCommand {
    ...
    public void process() throws ServletException, IOException {
        ...
        request.setAttribute("readers", userDAO.findReaders(user));
        request.setAttribute("myBooks", bookDAO.findAllBooks());

        forward("recommendBook");
    }
}
